...
Namespace Interfaz
    Module MasSteam
        ...
        Public Async Sub Cargar()
            ...
            Dim grid As Grid = pagina.FindName("gridMasSteam")
            grid.Children.Clear()
                            ...
                            If apps.Apps.Count > 0 Then
                                For Each app2 In apps.Apps
                                    ...
                                    Dim tbToolTip As TextBlock = New TextBlock With {
                                        .FontSize = 16,
                                        .TextWrapping = TextWrapping.Wrap,
                                        .Text = recursos.GetString("MoreSteamOpen")
                                    }
        ...
        Private Sub GenerarError(grid As Grid)
            ...
            Dim tbMensaje As New TextBlock With {
                .Text = recursos.GetString("MoreSteamError"),
                .Foreground = New SolidColorBrush(Colors.White),
                .TextWrapping = TextWrapping.Wrap
            }
            ...
            Dim tbBoton As New TextBlock With {
                .Text = recursos.GetString("MoreSteamOpenWeb"),
                .Foreground = New SolidColorBrush(Colors.White)
            }
